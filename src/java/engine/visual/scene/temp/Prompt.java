...
public final class Prompt extends SceneTemplate {
    ...
    public void render2D(Overlay overlay, Render textRender) {
        ...
        textRender.drawText(overlay, "Scale 2", 32f, 160f, 2f, Render.TextScale.standard(2f));
        textRender.drawText(overlay, "Scale 3", 32f, 180f, 2f, Render.TextScale.standard(3f));
        textRender.drawText(overlay, "Scale 4", 32f, 212f, 2f, Render.TextScale.standard(4f));

        textRender.drawText(overlay, "FIXED MODE", 360f, 136f, 2f, Render.TextScale.standard());
        textRender.drawText(overlay, "Fixed 2", 376f, 160f, 2f, Render.TextScale.fixed());
        textRender.drawText(overlay, "Fixed 3", 376f, 180f, 3f, Render.TextScale.fixed());
        textRender.drawText(overlay, "Fixed 4", 376f, 212f, 4f, Render.TextScale.fixed());

        textRender.drawText(overlay, "RELATIVE MODE", 680f, 136f, 2f, Render.TextScale.standard());
        textRender.drawText(overlay, "Relative +0", 696f, 160f, 2f, Render.TextScale.relative(0f));
        textRender.drawText(overlay, "Relative +1", 696f, 180f, 2f, Render.TextScale.relative(1f));
        textRender.drawText(overlay, "Relative +2", 696f, 212f, 2f, Render.TextScale.relative(2f));
        ...
        textRender.drawText(overlay, "Press L for hardware/specs log", 16f, 524f, 2f, Render.TextScale.standard());
    }
}
